...
Métis Ask wires intensity and on/off in the LOCKED CAVEMAN register line. Obey that line. Do not wait for a slash command in the question.
...
This skill is the Ask answer register, not Operator pack push and not a tenth conversation mode.
