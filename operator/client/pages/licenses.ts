/**
 * Licenses page client init (plan P0.4 prep, dev-shell). Empty for now: whatever client-side
 * wiring the Licenses page needs today still lives in operator/client/{filters,actions,licenses}.ts,
 * called from operator/client/main.ts's reinitPage(). The Licenses page owner moves that logic in
 ...
 *
 * Called with the page's own `[data-page="licenses"]` section element and, on a rerender()
