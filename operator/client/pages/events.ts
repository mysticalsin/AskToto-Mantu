/**
 * Events page client init (plan P0.4 prep, dev-shell). Empty for now: whatever client-side
 * wiring the Events page needs today still lives in operator/client/{filters,actions,licenses}.ts,
 * called from operator/client/main.ts's reinitPage(). The Events page owner moves that logic in
 ...
 *
 * Called with the page's own `[data-page="events"]` section element and, on a rerender()
