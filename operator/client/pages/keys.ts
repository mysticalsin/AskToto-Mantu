/**
 * Keys page client init (plan P0.4 prep, dev-shell). Empty for now: whatever client-side
 * wiring the Keys page needs today still lives in operator/client/{filters,actions,licenses}.ts,
 * called from operator/client/main.ts's reinitPage(). The Keys page owner moves that logic in
...
export function initKeys(section: HTMLElement, data: DashboardPayload | null): void {
  void section
  void data
}
