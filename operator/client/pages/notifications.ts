/**
 * Notifications page client init (plan P0.4 prep, dev-shell). Empty for now: whatever client-side
 * wiring the Notifications page needs today still lives in operator/client/{filters,actions,licenses}.ts,
 * called from operator/client/main.ts's reinitPage(). The Notifications page owner moves that logic in
 ...
 *
 * Called with the page's own `[data-page="notifications"]` section element and, on a rerender()
