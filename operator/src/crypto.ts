...
function decodeAesKey(raw: string, name: string): Uint8Array {
...
async function encryptAesGcm(plaintext: string, keyBytes: Uint8Array): Promise<{ cipher: string; iv: string }> {
...
async function decryptAesGcm(cipher: string, iv: string, keyBytes: Uint8Array): Promise<string> {
