...
describe('product sidebar (#105)', () => {
  ...
  it('mirrors Shoey chrome with Métis nouns and no shoe SKUs', async () => {
    ...
    expect(realtime).toContain('Users per countries')
    expect(realtime).toContain('data-map-dashboard')
    expect(realtime).toContain('Map and dashboard')
    ...
    expect(eventsPage).toContain('Paginate through your events, conversions and overall stats')
