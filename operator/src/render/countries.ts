/** ISO 3166-1 alpha-2 -> English short name. Not exhaustive (no micro-territories), but covers
 * every country Cloudflare `request.cf.country` commonly reports. Used only for flag() titles;
 * an unknown code falls back to the code itself, never a fake name. */
