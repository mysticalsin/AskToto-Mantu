 ...
 * the script skips the spawn when the target is not the host, so these cases exercise the
 * portability gate alone, on Linux and Windows CI as well as on a Mac.
 */
