    ...
    <header className="sticky top-0 z-20 border-b border-[var(--color-mantu-border)] bg-[var(--color-mantu-bg)]/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
        <div className="flex items-center gap-3">
          {/* Real Mantu brand mark (same asset as the dashboard's favicon), not a plain purple square
              standing in for it. BASE_URL keeps it working in the packaged file:// build. */}
          <img
