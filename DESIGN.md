...
- **Materials.** Translucent energy volume: luminous magenta core, indigo/violet halo, one specular kiss (~36% 30%), thin star flare. No particle constellation, no fibonacci cloud, no electron chords. Perspective ray-sphere, not a 2D radial fill. Reduced-motion still looks spherical (lit still frame, not a disc).
