...
- **Materials.** Shaded glass volume: fresnel rim, one specular kiss (~36% 30%), soft volumetric core, faint outer bloom. No particle constellation, no fibonacci cloud, no electron chords. Perspective ray-sphere, not a 2D radial fill. Reduced-motion still looks spherical (lit still frame, not a disc).
