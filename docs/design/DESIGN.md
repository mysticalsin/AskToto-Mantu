...
## Bar sphere
See [BAR-PILL.md](./BAR-PILL.md). The Bar control is a 52×52 Fit Studio glow core (idle `#b266e9` / `#e15cff` / `#8a00f8`). Same sphere when minimized. Not stuffed into overlay Hide/Island. Tony overrode Jarvis cyan on this control.
