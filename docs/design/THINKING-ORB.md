...
Starfield bed is a different PR. Overlay chrome geometry is a different PR. The Bar / minimized pill circle is specified in [BAR-PILL.md](./BAR-PILL.md) (same package, size 64, idle `solving`, no caption). Do not fight either.
