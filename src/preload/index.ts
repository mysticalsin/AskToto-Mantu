...
import {
  ...
  type DustCliImport,
  type DustConnectResult,
  type DustDetectResult,
...
const api = {
  ...
  dustConnect: (): Promise<DustConnectResult> => ipcRenderer.invoke(IPC.dustConnect),
  dustDetect: (): Promise<DustDetectResult> => ipcRenderer.invoke(IPC.dustDetect),
