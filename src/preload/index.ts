...
const api = {
  ...
  // Same plug-and-play shape as ClickUp: opens the system browser, finishes on loopback callback,
  // main has already persisted tokens + upserted mcpConnections by the time this resolves.
