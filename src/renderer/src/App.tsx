    ...
    >
      ...
      {minimized ? (
        <div className="flex w-full justify-center">
          <ControlPill
            // Gated the same way the Bar's own `listening` prop is (see showListeningChrome's comment
            // above) — otherwise the pill kept showing "live" chrome for up to DRAIN_CEILING_MS (4s) after
            // Stop while listen.listening was still draining audio in the background.
            listening={showListeningChrome}
