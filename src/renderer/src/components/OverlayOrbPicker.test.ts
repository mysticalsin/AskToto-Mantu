...
describe('Settings Bar rest orb cards', () => {
  it('renders Circle (default thinking-orb) and Jarvis (particles), never Obsidian or a gray box', () => {
    ...
    expect(picker).toMatch(/overlay-orb-diagram__jakub/)
    expect(picker).toMatch(/data-orb-diagram-engine="thinking-orbs"/)
