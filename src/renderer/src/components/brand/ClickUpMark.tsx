/**
 * Official ClickUp mark — simple-icons `clickup` path (CC0). Trademark remains ClickUp.
 * Hex #7B68EE from https://clickup.com/brand. See docs/design/BRAIN-CONNECTORS.md.
 */
export function ClickUpMark({ size = 28 }: { size?: number }): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
